...
export default function Homepage() {
    return (
        <div className="w-full h-full flex flex-col">
            ...
            <div className="w-full h-72 md:h-96 lg:h-auto flex flex-row justify-center items-center bg-black px-4 pt-4 pb-24">
                ...
                <div className="flex flex-col justify-center">
                    <div className="flex flex-col items-center transform rotate-90 text-white">
                        <a className="w-44 lg:w-56 lg:text-xl flex flex-row justify-center items-center py-2 px-4 gap-2 border-none rounded-full bg-dbblue font-semibold h-min hover:bg-opacity-90 cursor-pointer">
                            CONTACT US
            ...
            <div className="w-full flex flex-col items-center gap-4">
                ...
                <div className="w-full lg:w-4/6 h-[48rem] border-4"></div>
            </div>
